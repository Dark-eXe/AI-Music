...
def MusicTest(inst, artist, tempo, numMeasures, inputFile, showSheetMusic):
    ...
    # Adds more checks that handles all possible edge cases.
    # The following handles the case where user doesn;t select anything. If thats the case, error-message will be outputted.
    if not inst:
